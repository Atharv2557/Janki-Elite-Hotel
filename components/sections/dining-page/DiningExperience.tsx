...
export default function DiningExperience() {
  ...
  return (
    ...
    <div
  ref={imageWrapRef}
  className="dining-premium-card group relative h-[320px] overflow-hidden rounded-[1.75rem] border border-[#eadfce] bg-[#fbf7f0] shadow-xl shadow-[#211711]/10 md:h-[420px] lg:h-[460px]"
>
 <div ref={imageRef} className="absolute inset-0">
  <Image
    ...
    className="dining-premium-image object-cover"
  />
</div>

          <div className="dining-premium-overlay absolute inset-0 bg-gradient-to-t from-black/55 via-transparent to-transparent" />

          <div className="absolute bottom-6 left-6 right-6 rounded-2xl border border-white/10 bg-black/35 p-5 text-white backdrop-blur-md transition-transform duration-[1000ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:-translate-y-2">
        ...
        <div ref={contentRef}>
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-semibold leading-tight tracking-[-0.04em] text-[#5f5148] md:text-6xl">
            {experience.title}
          </h2>
          ...
          <ul className="mt-9 grid gap-4">
            {experience.features.map((feature, index) => (
              <li
                ...
                className="dining-soft-card group flex items-start gap-4 rounded-2xl border border-[#eadfce] bg-[#fbf7f0] p-5 shadow-sm"
              >
                <span className="dining-soft-icon mt-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-[#c8a45d]/50 text-xs text-[#c8a45d]">
                  {index + 1}
                </span>
